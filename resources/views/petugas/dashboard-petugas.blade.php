...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="/create-petugas">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Buat Akun Petugas</span></a>
            </li> -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- <a href="/data-laporan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
